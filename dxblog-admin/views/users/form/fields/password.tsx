...
import { FormControl, FormErrorMessage, FormLabel, Input, Card, CardHeader, CardBody, Heading, InputRightElement, Button } from '@chakra-ui/react';
        ...
        <Card variant="outline">
            ...
            <CardBody>
                ...
                <FormControl isInvalid={!!errors?.confirm_password} isRequired>
                    <FormLabel htmlFor="confirm_password">Last name</FormLabel>
                    <Input id="confirm_password" name="confirm_password" autoComplete="off" {...register('confirm_password', { required: 'Please confirm your password' })} />
